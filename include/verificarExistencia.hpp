 ...
 * 
 * @param db Puntero a la base de datos
 * @param idCuenta Id del préstamo que se quiere verificar
 * @return true Si el registro del préstamo no existe en la base de datos
 * @return false 
 */
bool prestamoExiste(sqlite3* db, int idCuenta);

/**
 * @brief Función para verificar si un cliente existe en la base de datos
 * 
 * @param db Puntero a la base de datos
 * @param idCuenta Id del CDP que se quiere verificar
 ...
 */
bool cdpExiste(sqlite3* db, int idCuenta);
